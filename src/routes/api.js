...
router.put('/config', (req, res) => {
  ...
  const allowed = ['nativeLang', 'targetLangs', 'currentLang', 'uiLang', 'darkMode', 'offlineMode', 'showGreenBorder', 'showConfetti', 'dateFormat', 'autoTranslate', 'suggestions', 'hideZeroStats', 'accentColor'];
